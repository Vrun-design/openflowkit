...
export { NODE_DEFAULTS, getDefaultColor } from './nodeDefaults';
export { SECTION_COLOR_PALETTE };
export type { SectionColors } from './sectionPalette';
import { SECTION_COLOR_PALETTE } from './sectionPalette';
